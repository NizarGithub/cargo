		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Tambah Data Pengeluaran Giro </span>
				</div>
				<div class="actions">
                    ...
                    <div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a href="<?=base_url();?>pengeluaran_giro_c" id="batal" class="btn red">Batal Dan Kembali</a>
...
function ajax_transaksi(){
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>pengeluaran_giro_c/get_trx_popup',
        type : "POST",
        dataType : "json",
        data : {
            keyword : keyword,
...
function get_produk_detail(no_trx){
    $('#no_trx').val(no_trx);
    var isine =    '<tr style="cursor:pointer;">'+
                        '<td style="text-align:center">1</td>'+
                        '<td text-align="left">'+no_trx+'</td>'+
                        '<td text-align="center">'+
                        '<input style="text-align:right;" type="text" class="form-control" value="" name="nilai" id="nilai" onkeyup="FormatCurrency(this);">'+
                        '</td>'+                           
                    '</tr>';
    $('#dataDetailTrx').html(isine);

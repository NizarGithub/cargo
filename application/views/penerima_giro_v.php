...
<div class="row">
	...
	<div class="col-md-2">
		<a href="<?=base_url();?>penerima_giro_c/add_new" class="btn green" style="float: right;">
		Tambah Data Penerimaan Giro <i class="fa fa-plus"></i>
		</a>
	</div>
</div>
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:center; vertical-align: middle;">
						<!-- <a class="btn default btn-xs purple" id="ubah" href="<?=base_url();?>penerima_giro_c/edit/<?=$value->ID;?>"><i class="fa fa-edit"></i> Ubah </a> -->
						<a class="btn default btn-xs red" id="hapus" onclick="hapus_divisi(<?php echo $value->ID?>);"><i class="fa fa-trash-o"></i> Hapus </a>
						<a target="_blank" class="btn default btn-xs green" id="cetak" href="<?=base_url();?>penerima_giro_c/cetak/<?=$value->ID;?>" ><i class="fa fa-print"></i> Cetak </a>
					</td>
				</tr>
					<?php 
						}

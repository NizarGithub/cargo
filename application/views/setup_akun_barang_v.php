				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>" enctype="multipart/form-data">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select class="form-control input-large select2me input-sm" id="id_satuan" name="nama_barang" data-placeholder="Select..." onchange="get_nama_satuan();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="form_control_1">Akun Kredit</label>
							<div class="col-md-4">
								<select class="form-control input-large select2me input-sm" id="id_supplier" name="akun_kredit" data-placeholder="Select..." onchange="get_nama_supplier();">
									<option value=""></option>
									<?php 
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="form_control_1">Akun Debet</label>
							<div class="col-md-4">
								<select class="form-control input-large select2me input-sm" id="id_kategori" name="akun_debet" data-placeholder="Select..." onchange="get_nama_kategori();">
									<option value=""></option>
									<?php 
...
Tambah Akun Data Barang <i class="fa fa-plus"></i>
</button>
</br>
</br>
...
<div class="row" id="table_barang" style="display:block; ">
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Table Akun Barang
				</div>
				<div class="tools">

...
<div class="row">
	...
	<div class="col-md-2">
		<a href="<?=base_url();?>pemasukan_bank_c/add_new" class="btn green" style="float: right;">
		Tambah Data Bank Masuk <i class="fa fa-plus"></i>
		</a>
	</div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Data Bukti Bank Masuk
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:left; vertical-align:"><?php echo $value->DARI; ?></td>
					...
					<td style="text-align:center; vertical-align: middle;">
						<!-- <a class="btn default btn-xs purple" id="ubah" href="<?=base_url();?>pemasukan_bank_c/edit/<?=$value->ID;?>"><i class="fa fa-edit"></i> Ubah </a> -->
						<a class="btn default btn-xs red" id="hapus" onclick="hapus_divisi(<?php echo $value->ID?>);"><i class="fa fa-trash-o"></i> Hapus </a>
						<a target="_blank" class="btn default btn-xs green" id="cetak" href="<?=base_url();?>pemasukan_bank_c/cetak/<?=$value->ID;?>" ><i class="fa fa-print"></i> Cetak </a>
					</td>
				</tr>
					<?php 
						}

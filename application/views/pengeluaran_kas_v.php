...
<div class="row">
	...
	<div class="col-md-2">
		<a href="<?=base_url();?>pengeluaran_kas_c/add_new" class="btn green">
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Data Bukti Kas Keluar
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:center; vertical-align: middle;">
						<!-- <a class="btn default btn-xs purple" id="ubah" href="<?=base_url();?>pengeluaran_kas_c/edit/<?=$value->ID;?>"><i class="fa fa-edit"></i> Ubah </a> -->
						<a class="btn default btn-xs red" id="hapus" onclick="hapus_divisi(<?php echo $value->ID?>);"><i class="fa fa-trash-o"></i> Hapus </a>
						<a target="_blank" class="btn default btn-xs green" id="hapus" href="<?=base_url();?>pengeluaran_kas_c/cetak/<?=$value->ID;?>" ><i class="fa fa-print"></i> Cetak </a>
					</td>
				</tr>
					<?php 
						}

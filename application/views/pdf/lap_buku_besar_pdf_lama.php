    ...
    <?php
        ...
        foreach ($dt as $key => $row) {
            ...
            if ($old_koper != $koper) {
                ...
                echo "<tr>" ;
                echo "<td style='vertical-align:middle; height:15px; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border'> <font style='font-size:15px;'> KODE AKUN : </font> </td>" ;
                echo "<td style='vertical-align:middle; height:15px; background:#FFF; border-bottom:1px solid black; border-left:none; border-right:none;' class='isi_no_border' colspan='5'> <b style='font-size:15px;'>(".$koper.") ".$row->NAMA_AKUN."</b> </td>" ;
                echo "</tr>" ;
            ...
            if ($key < $last_key) {
                $k          = $key + 1;
                $next_koper = trim($dt[$k]->KODE_AKUN) ;
            }

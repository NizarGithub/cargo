...
<table align="center" class="grid" style="width:100%;">
    <tr>
        ...
        <th style='text-align:center; width:50%;' class='kolom_header'> &nbsp; </th>
        <th style='text-align:center;' class='kolom_header'> Saldo Periode Ini </th>
        <th style='text-align:center;' class='kolom_header'> Saldo Periode Lalu </th>
    </tr>
    ...
    foreach ($dt_aktiva as $key => $row_aktiva) {
        ...
        if ($old_koper != $koper) {
            ...
            echo "<tr>" ;
                echo "<td align='left' colspan='2'> <b style='font-size:14px;'> ".$koper." </b> </td>" ;
        ...
        echo "<tr>" ;
        echo "<td class='gridtd tdku' align='left'>".$row_aktiva->KODE_AKUN."</td>" ;
        echo "<td class='gridtd tdku' align='left'>".$row_aktiva->NAMA_AKUN."</td>" ;
        echo "<td class='gridtd tdku' align='right'>".format_akuntansi($nilSaldo)."</td>" ; 
        echo "<td class='gridtd tdku' align='right'>".format_akuntansi($nilSaldoLalu)."</td>" ; 
        echo "</tr>" ;
        ...
        if ($koper != $next_koper || $key >= $last_key) {
            echo "<tr>" ;
                ...
                echo "<td style='border:none;' align='left'> &nbsp;&nbsp;&nbsp; <b> Jumlah ".$koper." </b> </td>" ;
                echo "<td style='border-top:1px solid black; text-align:right;'><hr style='border-style:double;'><b>".format_akuntansi($saldo)."</b></td>" ; 
                echo "<td style='border-top:1px solid black; text-align:right;'><hr style='border-style:double;'><b>".format_akuntansi($saldo_lalu)."</b></td>" ; 
            echo "</tr>" ; 
    ...
    echo "<tr>" ;
        echo "<td align='left' colspan='2'> <b> TOTAL ASET </b> </td>" ;
        echo "<td align='right'><b>".format_akuntansi($saldo_all)."</b></td>" ; 
        echo "<td align='right'><b>".format_akuntansi($saldo_lalu_all)."</b></td>" ; 
    echo "</tr>" ; 
...
<table align="center" class="grid" style="width:100%;">    
    ...
    foreach ($dt_wajib as $key2 => $row_wajib) {
        ...
        if ($old_koper != $koper) {
            ...
            echo "<tr>" ;
                echo "<td class='gridtd' align='left' colspan='2'> <b style='font-size:14px;'> ".$koper." </b> </td>" ;
        ...
        echo "<tr>" ;
        echo "<td class='gridtd' align='left'> &nbsp;&nbsp;&nbsp; - ".$row_wajib->KODE_AKUN."</td>" ;
        ...
        if ($koper != $next_koper2 || $key2 >= $last_key2) {
            echo "<tr>" ;
                echo "<td style='border:1px solid black;' align='left'  class='gridtd' colspan='2'> &nbsp;&nbsp;&nbsp; <b> Jumlah ".$koper." </b> </td>" ;
    ...
    echo "<tr>" ;
        echo "<td style='border:1px solid black;' align='left'  class='gridtd' colspan='2'> <b> TOTAL KEWAJIBAN DAN EKUITAS </b> </td>" ;

		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form Edit Akun Barang </span>
				</div>
				<div class="actions">
				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="kode_barang" name="kode_barang" value="<?=$lihat_data->kode_barang;?>" >
						...
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id="nama_barang" name="nama_barang" value="<?=$lihat_data->nama_barang;?>">
								<div class="form-control-focus">
								</div>
							</div>
						</div>

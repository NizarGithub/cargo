...
<div class="row">
	...
	<div class="col-md-2">
		<a href="<?=base_url();?>pengakuan_hutang_c/add_new" class="btn green" style="float: right;">
		Tambah Data Pengakuan Hutang <i class="fa fa-plus"></i>
		</a>
	</div>
</div>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Data Tanda Terima Tagihan
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<tr>
					...
					<td style="text-align:center; vertical-align: middle;">
						...
						<a target="_blank" class="btn default btn-xs green" id="hapus" href="<?=base_url();?>pengakuan_hutang_c/cetak/<?=$value->ID;?>" ><i class="fa fa-print"></i> Cetak </a>
					</td>
				</tr>
					<?php 
						}

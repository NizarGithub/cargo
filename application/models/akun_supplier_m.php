...
class Akun_supplier_m extends CI_Model
{
	...
	function lihat_data_supplier_edit($id)
	{
		$sql = "
			SELECT * FROM master_supplier WHERE id_supplier = '$id' ";
	...
	function simpan_data_supplier_akun($id,$nama,$akun_debit,$akun_kredit)
	{
		$sql = "
			UPDATE master_supplier SET

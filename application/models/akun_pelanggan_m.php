...
class Akun_pelanggan_m extends CI_Model
{
	...
	function lihat_data_pelanggan_edit($id)
	{
		$sql = "
			SELECT * FROM master_pelanggan WHERE id_pelanggan = '$id' ";
	...
	function simpan_data_pelanggan_akun($id,$nama,$akun_debit,$akun_kredit)
	{
		$sql = "
			UPDATE master_pelanggan SET

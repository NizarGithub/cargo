...
class Setup_akun_barang_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('setup_akun_barang_m','setup_akun_barang');
	...
	{
		$data = array(
				'title' 	      => 'Master Setup Akun Barang',
				'page'  	      => 'setup_akun_barang_v',
				'sub_menu' 	      => 'Setup data',
				'sub_menu1'	      => 'Master Akun Barang',
				'menu' 	   	      => 'master_data',
				'menu2'		      => 'setup_barang',
				'lihat_data'      => $this->setup_akun_barang->lihat_data_barang(),
				'lihat_satuan'    => $this->setup_akun_barang->lihat_data_satuan(),
				'lihat_supplier'  => $this->setup_akun_barang->lihat_data_supplier(),
				'lihat_kategori'  => $this->setup_akun_barang->lihat_data_kategori(),
				'url_simpan' 	  => base_url().'setup_akun_barang_c/simpan',
				'url_hapus'  	  => base_url().'setup_akun_barang_c/hapus',
				'url_ubah'	 	  => base_url().'setup_akun_barang_c/ubah_barang',
			);

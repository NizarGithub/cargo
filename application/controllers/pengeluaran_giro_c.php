...
class Pengeluaran_giro_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('pengeluaran_giro_m','model');
	...
	public function index()
	{
		...
		$data = array(
				'title' 	 		=> 'Pengeluaran Giro',
				'page'  	 		=> 'pengeluaran_giro_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Pengeluaran Giro',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'pengeluaran_giro',
				'lihat_data' 		=> $this->model->lihat_data(),
				'url_simpan' 		=> base_url().'pengeluaran_giro_c',
				'url_hapus'  		=> base_url().'pengeluaran_giro_c',
				'url_ubah'	 		=> base_url().'pengeluaran_giro_c',
				'get_nomor'	 		=> $get_nomor,
			);
	...
	function add_new(){
		...
		$data = array(
				'title' 	 		=> 'Tambah Data Pengeluaran Giro',
				'page'  	 		=> 'add_pengeluaran_giro_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Pengeluaran Giro',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'pengeluaran_giro',
				...
				'url_simpan' 		=> base_url().'pengeluaran_giro_m',
				'url_hapus'  		=> base_url().'pengeluaran_giro_m',
				'url_ubah'	 		=> base_url().'pengeluaran_giro_m',
				'get_nomor'	 		=> $get_nomor,
			);
	...
	function get_trx_popup()
	{
		$where = "1=1";

		$keyword = $this->input->post('keyword');
		if($keyword != "" || $keyword != null){
			$where = $where." AND (a.NO_TRX LIKE '%$keyword%' OR a.supplier LIKE '%$keyword%')";
		}

		$sql = "
		SELECT a.* FROM (
		SELECT no_po AS NO_TRX, tanggal, supplier, sub_total FROM tb_purchase_order

		UNION ALL 

		SELECT no_spb AS NO_TRX, tanggal, b.nama_supplier as supplier, sub_total FROM tb_pembelian_jasa a 
		LEFT JOIN master_supplier b ON a.kode_supplier = b.id_supplier
		) a 
		WHERE $where
		";

...
class Perintah_membayar_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('perintah_membayar_m','model');
	...
	public function index()
	{
		...
		$data = array(
				'title' 	 		=> 'Perintah Membayar (PM)',
				'page'  	 		=> 'perintah_membayar_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Perintah Membayar',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'perintah_membayar',
				'lihat_data' 		=> $this->model->lihat_data(),
				'url_simpan' 		=> base_url().'perintah_membayar_c',
				'url_hapus'  		=> base_url().'perintah_membayar_c',
				'url_ubah'	 		=> base_url().'perintah_membayar_c',
				'get_nomor'	 		=> $get_nomor,
			);
	...
	function add_new(){
		...
		$data = array(
				'title' 	 		=> 'Tambah Data Perintah Membayar (PM)',
				'page'  	 		=> 'add_perintah_membayar_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Perintah Membayar',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'perintah_membayar',
